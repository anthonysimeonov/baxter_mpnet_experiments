...
--model_path ./models/sample/voxel3_001_1000_multiview/ --mlp_model_name mlp_PReLU_ae_dd120.pkl --enc_model_name cae_encoder_120.pkl --experiment_name test_experiment \
