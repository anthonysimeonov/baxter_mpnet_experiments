...
--batch_size 100 --ae_learning_rate 0.001 --mlp_learning_rate 0.001 --num_epochs 400 \
--enc_input_size 16053 --enc_output_size 60 --mlp_input_size 74 --mlp_output_size 7 --start_epoch 200 \
