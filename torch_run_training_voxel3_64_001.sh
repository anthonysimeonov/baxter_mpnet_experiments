...
--trained_model_path ./models/sample/voxel3_64_001/ \
--batch_size 100 --learning_rate 0.001  --num_epochs 400 \
--enc_input_size 64 --enc_vox_size 64 --enc_output_size 128 --mlp_input_size 142 --mlp_output_size 7 --AE_type voxel3 --N 1 --NP 100 \
--device 3 --exp_name voxel3
