...
--enc_input_size 16053 --enc_output_size 128 --mlp_input_size 142 --mlp_output_size 7 --start_epoch 200 \
--AE_start_epoch 200 --AE_restore_pretrain 0 --pretrain 0 --pretrain_epochs 500 --pretrain_batch_size 50 \
--fixAE 0 --experiment_name no_pretrain --device 0 --AE_type pointnet \
