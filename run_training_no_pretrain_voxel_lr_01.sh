...
--batch_size 100 --ae_learning_rate 0.01 --mlp_learning_rate 0.01 --num_epochs 500 \
...
--fixAE 0 --experiment_name no_pretrain_voxel_01 --device 1 --AE_type voxelnet --NP 100
