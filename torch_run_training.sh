...
--trained_model_path ./models/sample/linear/ \
--batch_size 100 --learning_rate 0.001  --num_epochs 210 \
--enc_input_size 16053 --enc_output_size 60 --mlp_input_size 74 --mlp_output_size 7 --device 0 \
