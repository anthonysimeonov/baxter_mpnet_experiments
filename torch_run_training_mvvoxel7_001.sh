...
--trained_model_path ./models/sample/mvvoxel7_001/ \
--batch_size 100 --learning_rate 0.001  --num_epochs 200 \
--enc_input_size 32 --enc_output_size 128 --mlp_input_size 142 --mlp_output_size 7 --AE_type mvvoxel7 --N 10 --NP 1000 \
--device 3 --exp_name mvvoxel7
