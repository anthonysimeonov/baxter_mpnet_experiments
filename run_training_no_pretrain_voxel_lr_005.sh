...
--batch_size 100 --ae_learning_rate 0.005 --mlp_learning_rate 0.005 --num_epochs 500 \
...
--fixAE 0 --experiment_name no_pretrain_voxel_005 --device 3 --AE_type voxelnet --NP 100
