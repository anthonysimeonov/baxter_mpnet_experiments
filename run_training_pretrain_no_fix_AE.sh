...
--AE_start_epoch 500 --AE_restore_pretrain 1 --pretrain 0 --pretrain_epochs 500 --pretrain_batch_size 50 \
--fixAE 0 --experiment_name pretrain_no_fix_AE --device 2 --NP 100
